...
- [`docs/governance/README.md`](docs/governance/README.md) — Phase 1 release governance index (PLATFORM-GOV-001 / package-level closure PLATFORM-GOV-002 / Kanon union guard PLATFORM-GOV-003).
