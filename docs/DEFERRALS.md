...
| PLAT-DEF-002 | Errors | Uniform cross-service error envelope enforcement | Product repos must align first | Medium — inconsistent operator UX | SHARED-ERROR-CONTRACT-001 |
...
| PLAT-DEF-004 | Intake | `_archived/` as first-class intake tier | Validator change across repos | Low | BACKEND-REPO-DOCS-ORDER-002 |
| PLAT-DEF-005 | Docs | Populate `docs/generated/` | No generator wired yet | Low | BACKEND-REPO-DOCS-ORDER-002 |
