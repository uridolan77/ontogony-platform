...
Real provider validation v1 (RP-*)       ACTIVE (RP-003 Allagma guided flow done)
...
**Done:** `RP-000`–`RP-003` (2026-05-19). **Next:** `RP-004` frontend operator visibility. Policy: [`REAL_PROVIDER_LOCAL_VALIDATION_POLICY.md`](../operators/REAL_PROVIDER_LOCAL_VALIDATION_POLICY.md). Allagma evidence: [`RP_003_ALLAGMA_REAL_PROVIDER_GUIDED_FLOW_EVIDENCE.md`](../evidence/RP_003_ALLAGMA_REAL_PROVIDER_GUIDED_FLOW_EVIDENCE.md).
