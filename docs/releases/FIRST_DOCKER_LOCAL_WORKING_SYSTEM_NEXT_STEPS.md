...
**Active PR:** `FE-HYGIENE-CONFIG-001` — Frontend config hygiene.

**Completed:** `CONEXUS-PERSIST-001`–`003`, `KANON-OP-001`, `KANON-OP-002`, `TRACE-CONTRACT-001`, `FE-HARDEN-001`, `FE-AUDIT-FIXTURES-001`, `FE-TEST-REPLAY-001`.
