# Ontogony.Platform ΓÇö 0.4 alpha-RC substrate contract
...
| Contract name | **0.4 alpha-RC** ΓÇö RC certification label for the substrate contract family; not a package semver bump |
...
4. Coordinate downstream repos (Conexus, Kanon, Allagma) and **runtime lock** promotion in `allagma-dotnet` ΓÇö silent package bumps are forbidden for Phase 1.
...
| --- | --- | --- |
| Additive public API | Required for release notes; migration optional | ΓÇö |
...
Registry baseline promotion (`SYSTEM-ALPHA-006` ΓåÆ `SYSTEM-RC-001A`): [`docs/migrations/2026-05-22-platform-rc-001-substrate-contract-freeze.md`](../migrations/2026-05-22-platform-rc-001-substrate-contract-freeze.md).
...
| Rule | Detail |
| --- | --- |
| Owner | `ontogony-platform` ΓÇö [`docs/system/system-protocol-registry.json`](../system/system-protocol-registry.json) |
...
| When to refresh | After runtime lock promotion, RC certification PRs, or new cross-repo protocol surfaces ΓÇö never silently on unrelated PRs |
...
| Artifact | Status |
| --- | --- |
| [`SYSTEM_EVIDENCE_SPINE_CONTRACT.md`](../operators/SYSTEM_EVIDENCE_SPINE_CONTRACT.md) | **Frozen** ΓÇö observational resolver contract |
| [`system-evidence-spine-resolution.matrix.json`](../system/system-evidence-spine-resolution.matrix.json) | **PASS** ΓÇö `validate-system-evidence-spine-contract.ps1` |
| Golden run (SYSTEM-RC-001E) | **PASS** ΓÇö [`SYSTEM_RC_001E_EVIDENCE_SPINE_GOLDEN_RUN.md`](../../../allagma-dotnet/docs/evidence/SYSTEM_RC_001E_EVIDENCE_SPINE_GOLDEN_RUN.md) |
...
| [`operator-failure-taxonomy.matrix.json`](../system/operator-failure-taxonomy.matrix.json) | **PASS** ΓÇö `validate-system-operator-failure-taxonomy.ps1` |
...
| Criterion | Status |
| --- | --- |
| Protocol registry reflects runtime lock | **Required** ΓÇö see evidence |
...
| Consumer RC evidence linked | **Required** ΓÇö Allagma 001C, Kanon RC-001, Conexus RC-001 |
