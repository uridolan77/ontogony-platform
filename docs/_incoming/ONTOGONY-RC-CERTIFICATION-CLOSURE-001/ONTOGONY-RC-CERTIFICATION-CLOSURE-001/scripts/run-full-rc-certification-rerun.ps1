...
if ($UseExistingServices) { Run-InRepo "runtime-service-identity" $WorkspaceRoot ".\scripts\verify-ontogony-runtime-service-identity.ps1 -WorkspaceRoot '$WorkspaceRoot' -RequireAll -WriteEvidence" -Required }
$repoTestCommands = @(
...
Run-InRepo "runtime-service-identity-after-stack" $WorkspaceRoot "pwsh .\scripts\verify-ontogony-runtime-service-identity.ps1 -WorkspaceRoot '$WorkspaceRoot' -RequireAll -WriteEvidence" -Required
Run-InRepo "aisthesis-five-service-live-cert" (Join-Path $WorkspaceRoot "aisthesis-dotnet") "pwsh .\scripts\system\run-five-service-live-certification.ps1 -Mode Live" -Required
