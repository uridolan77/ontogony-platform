# Implementation Prompt — SYS-Q006-004-RESTART-PATH-DECISION

Read:

- `02-issue-cards/SYS-Q006-004-RESTART-PATH-DECISION.md`
- `00-context/02-boundaries-and-safety.md`
- `00-context/03-first-version-definition.md`

Then implement `SYS-Q006-004-RESTART-PATH-DECISION`.
