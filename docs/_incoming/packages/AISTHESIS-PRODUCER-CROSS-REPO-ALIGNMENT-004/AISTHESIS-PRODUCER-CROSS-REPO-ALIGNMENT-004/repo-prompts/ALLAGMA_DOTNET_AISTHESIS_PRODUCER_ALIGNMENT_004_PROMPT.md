# Cursor prompt — Allagma Aisthesis producer alignment 004

You are working in `allagma-dotnet`.
...
- `workstreams/A_ALLAGMA_PRODUCER_ALIGNMENT.md`
...
7. Write `docs/evidence/ALLAGMA_DOTNET_AISTHESIS_PRODUCER_ALIGNMENT_004_CLOSEOUT.md`.
