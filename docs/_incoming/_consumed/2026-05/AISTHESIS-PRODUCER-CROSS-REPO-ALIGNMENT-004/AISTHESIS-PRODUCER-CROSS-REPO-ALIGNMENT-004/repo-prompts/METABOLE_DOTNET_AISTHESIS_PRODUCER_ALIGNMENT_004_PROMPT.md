# Cursor prompt — Metabole Aisthesis producer alignment 004

You are working in `metabole-dotnet`.
...
- `workstreams/D_METABOLE_PRODUCER_ALIGNMENT.md`
...
7. Write `docs/evidence/METABOLE_DOTNET_AISTHESIS_PRODUCER_ALIGNMENT_004_CLOSEOUT.md`.
