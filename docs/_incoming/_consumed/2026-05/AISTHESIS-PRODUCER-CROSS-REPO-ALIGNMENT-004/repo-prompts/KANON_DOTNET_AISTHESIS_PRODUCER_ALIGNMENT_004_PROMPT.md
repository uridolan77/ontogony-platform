# Cursor prompt — Kanon Aisthesis producer alignment 004

You are working in `kanon-dotnet`.
...
- `workstreams/B_KANON_PRODUCER_ALIGNMENT.md`
...
7. Write `docs/evidence/KANON_DOTNET_AISTHESIS_PRODUCER_ALIGNMENT_004_CLOSEOUT.md`.
