...
| Conexus `POST /admin/v0/replay/route-decisions/{id}/dry-run` | **Wired (REPLAY-RUNTIME-FULL-INTEGRATION-001A)** — when `routeDecisionId` resolves from run/events or model-call evidence |
