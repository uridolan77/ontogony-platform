# Internal NuGet publishing workflow
...
- Document or automate package publishing for alpha consumers.
- Provide consumer upgrade checklist.
- Keep sibling project references supported while alpha.
...
- No changes to Conexus product architecture.
