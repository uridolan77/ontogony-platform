# Artifact classification/redaction helpers
...
- Add helper conventions for storing sensitive raw payloads by reference.
- Make classification strings opaque.
- Add tests ensuring artifact refs do not include payload bytes.
