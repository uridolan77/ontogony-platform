...
| 012 | Source-binding quality API + panel; workbench build | **Pending** — walk `/kanon/source-bindings` quality metrics, review queue, coverage, contradictions (see 012 evidence) |
