...
| Replay evidence | **Closed (FE-PRODUCT-003):** lookup modes, limitation-aware replay ops banner, export, evidence journey + cross-service links | `?replayFixture=` catalog; live replay trigger | follow-up |
